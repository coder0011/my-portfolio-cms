                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Write a new article for your portfolio site.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="rounded-xl border border-sidebar-border bg-card p-6 shadow-sm flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="mt-1 w-full rounded-md border border-input bg-background px-3 py-2 text-sm font-mono shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                                />
                        ...
                        <div className="rounded-xl border border-sidebar-border bg-card p-6 shadow-sm flex flex-col gap-4 sticky top-6">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex flex-col gap-2 mt-2">
                                    ...
                                    <div className="flex items-center justify-between text-xs border-b border-sidebar-border/50 pb-2">
                                        <span className="text-muted-foreground">Keyword density in content:</span>
