            ...
            <div className="flex flex-col gap-6 p-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Monitor admin dashboard activity, login history, and
                                ...
                                {logs.data.length === 0 ? (
                                    ...
                                    logs.data.map((log) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-4">
                                                <span className="inline-flex items-center rounded-full bg-primary/10 px-2 py-0.5 text-xs font-semibold text-primary uppercase">
                                                    {log.action.replace(
                                                        '_',
                                                        ' ',
                                                    )}
                                            ...
                                            <td
                                                className="max-w-[400px] truncate p-4 text-foreground/90"
                    ...
                    {logs.last_page > 1 && (
                        <div className="flex items-center justify-between border-t border-sidebar-border bg-muted/20 p-4">
                            <div className="text-xs text-muted-foreground">
                                ...
                                {logs.last_page} ({logs.total} total logs)
                            </div>
